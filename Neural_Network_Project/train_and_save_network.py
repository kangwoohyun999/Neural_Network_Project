...
"""
Usage:
  python train_and_save_network.py --team 6 --train-pkl ./data/train_data.pkl --save network_Team6.pkl

주의:
 - train_pkl은 (x_train,t_train,x_test,t_test) 형식 권장
 - 또는 (x_train,t_train, x_val, t_val)
"""
import argparse
import pickle
import numpy as np
from dataset.fashion_mnist_loader import load_data_from_pkl
from model.multilayer_net import MultiLayerNet
